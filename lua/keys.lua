...
-- Optional: Also make it work in command-line mode
...
map("n", "<Space>tmp", ":-tabmove<CR>", opts, { desc = "You can move them around?" })
-- move current tab to next position
map("n", "<Space>tmn", ":+tabmove<CR>", opts, { desc = "I have no idea man..."})
