...
-- Folding
-----------------------------------------------------------
-- Enable Tree-sitter based folding for C++
vim.opt.foldmethod = "expr"
vim.opt.foldexpr = "v:lua.vim.treesitter.foldexpr()"

-- Essential folding settings for C++
vim.opt.foldlevelstart = 99 -- Don't auto-close folds when opening files
vim.opt.foldnestmax = 10 -- Allow deep nesting for C++ classes/namespaces
vim.opt.foldminlines = 3 -- Only fold if at least 3 lines

-- Auto-close folds when leaving them for better focus
vim.opt.foldclose = "all"

-- Optional: Customize fold text to show function signatures
vim.opt.foldtext = "v:lua.vim.treesitter.foldtext()"
-- Save and restore folds
vim.opt.sessionoptions:append("folds") -- Save folds in sessions
